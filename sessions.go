...
func sessionInitializer() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if addBannedMessage {
			addMessage(c, warningMessage{T(c, "You have been automatically logged out of your account because your account has either been banned or locked. Should you believe this is a mistake, or it has been a month since your last offense, you can contact our support team at support@vipsu.ml.")})
		}
		if passwordChanged {
